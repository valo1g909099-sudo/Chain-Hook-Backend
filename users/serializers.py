...
class GenerateClientTokenSerializer(serializers.Serializer):
    ...
    callback_info = serializers.JSONField(required=False)
    ...
    def validate(self, attrs):
        ...
        if 'callback_info' in attrs and not isinstance(attrs['callback_info'], dict):
            raise serializers.ValidationError(
                {'callback_info': 'Must be a JSON object.'}
            )
